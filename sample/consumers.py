    ...
    async def connect(self):
        ...
        try:
            ...
            if conversation or self.website_id:
                # Try to get or create conversation if we have identification
                if not conversation and self.website_id:
                    conversation = await self.get_or_create_conversation()
                    if not conversation:
                        logger.error(f"Failed to create conversation {self.conversation_id}")

...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-9#@!a(svi=c^5_ayb-r+!a@!krs%26sypn+#br3^h$rp=gq@e@')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Allow API access for now
    ],
